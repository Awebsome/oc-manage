...
use AWME\Engine\Models\EngineSettings as Engine;
...
class Installer
{
    ...
    public function makeProject(){
        ...
        {
            $commands = [
                'cd '.Engine::get('projects_path').'/'.Request::input('Project.directory'),
    ...
    public function makeAjenti(){
        ...
        if (!$disk->exists($ajentiJson))
        {
            ...
            Config::set('ajenti.root', Engine::get('projects_path').'/'.Request::input('Project.directory'));
    ...
    public function makeAjentiReload(){
        ...
        $ajenti_path = Engine::get('projects_path').'/'.$conf_path.'/ajenti.json';
    ...
    public function delete(){
         ...
         */
        if(is_dir(Engine::get('projects_path').'/'.Request::input('Project.directory'))){
            $commands = [
                'cd '.Engine::get('projects_path'),
